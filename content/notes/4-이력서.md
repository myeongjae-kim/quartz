...
- Next.js v13의 [App Router](https://nextjs.org/docs/app)로 웹 애플리케이션을 작성하면서 필요한 라이브러리를 직접 구현
	- [⛓️return-fetch :: A simple and powerful high order function to extend fetch](https://return-fetch.myeongjae.kim/)
...
아래는 expect 스크립트의 템플릿이다. `{{ examples }}` 부분을 실제 값으로 교체한다.
...
CEO에게 추천서를 받고 Fast learner라고 인정을 받음. [추천서보기](https://cdn.myeongjae.kim/blog/2023/05/김명재_추천서_Sandeep_Reference_Letter.pdf)

<embed src="https://cdn.myeongjae.kim/blog/2023/05/김명재_추천서_Sandeep_Reference_Letter.pdf" width='100%' height='80vh'>
